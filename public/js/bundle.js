...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZWxpYWNvaGVuIiwiYSI6ImNrcXE3cjFjMzEzZWcydXN0dWp5MWdtM20ifQ.ZOBmfFQdDmImaqOkidU7Gw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p> Day ".concat(loc.day, "</p>")).addTo(map);
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in succesfuly');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51JASCJJXcyhdzAo6t2Kx5NMtp9NhZ9E8Bb4I4d9q6GgWDtimb838mTDQImw22WG4yaXJ1ph3QFSDsLYKZ8ojmasG00ywdNg7aa');
            _context.next = 4;
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var passwordCurrect, password, passwordConfirm;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            passwordCurrect = document.getElementById('password-current').value;
            password = document.getElementById('password').value;
            passwordConfirm = document.getElementById('password-confirm').value;
            _context2.next = 7;
            return (0, _updateSettings.updateSettings)({
              passwordCurrect: passwordCurrect,
              password: password,
